...
export class SideDrawerPageComponent implements AfterViewInit, OnDestroy {
  ...
  navMenu: any[] = [
    ...
    { name: 'Home1', commands: ['/'] },
    { name: 'About1', commands: ['/about'] },
    { name: 'Contact1', commands: ['/contact'] },
    { name: 'Home2', commands: ['/'] },
    { name: 'About2', commands: ['/about'] },
    { name: 'Contact2', commands: ['/contact'] },
    { name: 'Home3', commands: ['/'] },
    { name: 'About3', commands: ['/about'] },
    { name: 'Contact3', commands: ['/contact'] }
  ];
